...
cateName1Dir_Dict = {
    "jiehun":                   "jiehun/inc_v1",
    "xuexipeixun":              "xuexipeixun/inc_v1",
    "xidihuli":                 "xidihuli/inc_v1",
    "chongwu":                  "chongwu/inc_v1",
    "meishi":                   "meishi/inc_v1",
    "qinzi":                    "qinzi/inc_v1",
    "liren":                    "liren/inc_v1",
    "gouwu":                    "gouwu/inc_v1",
    "xiuxianyvle":              "xiuxianyvle/inc_v1",
    "yiliaojiankang":           "yiliaojiankang/inc_v1",
    "yundongjianshen":          "yundongjianshen/inc_v1",
    "lvxingshe":                "lvxingshe/inc_v1",
    "fuyouyiyuan":              "fuyouyiyuan/inc_v1"
}

one2two_cateName = {'jiehun': ['jiehun'], 'xuexipeixun': ['xuexipeixun'], 'xidifuli': ['xidifuli'], 'chongwu': ['chongwu'], 'meishi': ['huoguo', 'yinpindian', 'kafeiting', 'xican', 'shaokao', 'mianbaotiandian', 'xiaochikuaican', 'meishi-qita', 'luwei'], 'qinzi': ['qinzi'], 'liren': ['liren'], 'gouwu': ['yundonghuwai', 'gouwu-qita', 'chaoshibianli', 'shumachanpin', 'jiajujiancai',  'zongheshangchang', 'fuzhuangkuaixiao', 'shuiguo', 'huazhuangpin', 'xiexue'], 'xiuxianyvle': ['xiuxianyvle'], 'yiliaojiankang': ['yaodian', 'tijianzhongxin', 'yake'], 'yundongjianshen': ['yundongjianshen'],'lvxingshe':['lvxingshe'],'fuyouyiyuan':['fuyouyiyuan']}
